...
mock.patch("fastapi_cache.decorator.cache", lambda *args, **kwargs: lambda f: f).start()  # noqa
...
from src.database import async_session_maker_new_pool  # noqa

URL = "postgresql+asyncpg://postgres:password@localhost:5432/gg"

engine_new_pool = create_async_engine(url=URL, poolclass=NullPool)  # noqa
